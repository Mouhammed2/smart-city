...
// Async thunks
export const fetchAllBuses = createAsyncThunk("buses/fetchAll", async () => {
...
export const fetchNearestBuses = createAsyncThunk(
  ...
  async ({
    ...
    return await busService.findNearest(lat, lng, radius || 500);
  },
);
